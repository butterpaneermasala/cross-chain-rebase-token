...
contract CrossChainTest is Test {
    ...
    function bridgeTokens(
        ...
        IRouterClient(localNetworkDetails.routerAddress).ccipSend{value: localNetworkDetails.chainSelector == 1 ? fee : 0}(remoteNetworkDetails.chainSelector, message);
        uint256 localTokenBalanceAfter = localToken.balanceOf(user);
        assertEq(localTokenBalanceBefore - amountToBridge, localTokenBalanceAfter);
